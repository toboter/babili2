...
Devise.setup do |config|
  ...
  # config.secret_key = '0ed084e0635f8df72340ef344282569b78838a6a957dac01dcc252b137501315a49361a10f17402c9d2ab080849afe5213c855c0c8a7e86f6f68c598292d5d4d'
  ...
  # config.pepper = '4d3e72da90fc3668e6807f8de60f0d71ebb4a6a3b094650c2ea0b64d5f92730b62107e14fa46b8e94105042c9ef47953ce4a17ca1c9fe78a45a7996388831216'
...
Warden::Manager.after_set_user except: :fetch do |user, warden, _|
  ...
  warden.raw_session['auth_id'] = user.activate_session(ip: warden.request.ip, user_agent: warden.request.user_agent)
end
